...
$(function() {
    ...
    describe('The Menu', function() {
        ...
        it('toggles on and off', function() {
            ...
            expect(menu).not.toBe('menu-hidden'); //expect menu is not hidden
    ...
    describe('Initial Entries', function() {
        ...
        beforeEach(function(done) {
            loadFeed(0); //call loadFeed() for the 1st index
            done();
        });
    ...
    describe('New Feed Selection', function() {
        ...
        //loop over each entry in feedTwo and push its content to feedOne Array
        beforeEach(function(done) {
            loadFeed(0, done);
            Array.from(feedTwo.children).forEach(function(entry) {
